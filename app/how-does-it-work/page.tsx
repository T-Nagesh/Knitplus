      ...
      <section className="py-20 bg-green-900 text-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white ml-4 font-serif">How Does It Work?</h1>
          </div>

          <div className="grid-bg w-full py-8 flex items-center justify-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white font-serif tracking-wide">How does it work?</h1>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="relative">
                ...
                <div className="bg-green-800 p-6 rounded-lg">
                  <div className="bg-green-900 p-4 rounded-lg mb-4 inline-flex items-center justify-center">
                    <Search className="h-8 w-8" />
                  </div>
                  <h3 className="text-xl font-bold mb-4 text-yellow-400 font-serif">Browse and Order</h3>
              ...
              <div className="relative">
                ...
                <div className="bg-green-800 p-6 rounded-lg">
                  ...
                  <h3 className="text-xl font-bold mb-4 text-yellow-400 font-serif">Select Your Membership Plan</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">•</span>
              ...
              <div className="relative">
                ...
                <div className="bg-green-800 p-6 rounded-lg">
                  ...
                  <h3 className="text-xl font-bold mb-4 text-yellow-400 font-serif">Pickup</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">•</span>
              ...
              <div className="relative">
                ...
                <div className="bg-green-800 p-6 rounded-lg">
                  ...
                  <h3 className="text-xl font-bold mb-4 text-yellow-400 font-serif">Returns</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <span className="text-yellow-400 mr-2">•</span>
            ...
            <div className="text-center mt-16">
              <Button className="bg-yellow-500 hover:bg-yellow-600 text-green-900 font-serif">Join Now</Button>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-yellow-400 font-serif">Digital Design</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-yellow-400 font-serif">Sustainable Materials</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-yellow-400 font-serif">Production</h3>
