            ...
            <div className="grid md:grid-cols-2 gap-16">
              <div>
                <p className="text-lg mb-6 font-serif">
                  ...
                  <span className="text-yellow-400">eco-conscious approach to fashion</span>.
                </p>
              ...
              <div>
                <p className="text-lg mb-6 font-serif">
                  ...
                  solutions, we aim to{" "}
                  <span className="text-yellow-400">reduce waste and extend the life-cycle of items</span> and creating
                  a circular system for fashion's future.
                </p>

                <div className="mt-8">
                  <Link href="/about">
                    <Button className="bg-yellow-500 hover:bg-yellow-600 text-green-900 font-serif">Learn More</Button>
                  </Link>
                </div>
              </div>
            </div>
