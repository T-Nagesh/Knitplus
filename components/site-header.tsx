        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center">
              <nav className="mr-4">
                <div className="bg-green-800 rounded-full px-4 py-2 flex items-center space-x-4">
                  ...
                  <Link href="/webshop" className="text-white hover:text-yellow-400 transition-colors px-2 font-serif">
                    WEBSHOP
                  </Link>
            ...
            <div className="flex items-center md:hidden">
              <button
                className="relative p-2 text-white hover:text-yellow-400 transition-colors mr-2"
                onClick={() => setIsCartOpen(!isCartOpen)}
              >
                <ShoppingCart size={24} />
                {cartCount() > 0 && (
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-green-900">
          <nav className="flex flex-col px-4 py-4">
            <Link
              href="/about"
              className="text-white py-3 border-b border-green-800 hover:text-yellow-400 transition-colors font-serif"
